...
versions:
  - name: Version 2.0
    downloads:
      - name: Induction
        source: https://files.hypnoponies.net/files/character/lyra-heartstrings/Lyra Heartstrings - Inducer - BGM.mp3
      - name: Loop with BGM
        source: https://files.hypnoponies.net/files/character/lyra-heartstrings/Lyra Heartstrings - Loop - BGM.mp3
---
